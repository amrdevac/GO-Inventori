...
type ItemTableNested struct {
	IdBarang int    `form:"id_barang,omitempty" json:"id_barang" gorm:"column:id_barang;type:integer;not null;primaryKey;autoIncrement:true"`
	Nama     string `form:"nama" json:"nama" binding:"required" gorm:"column:nama;type:varchar(100);not null"`
	Harga    int    `form:"harga" json:"harga" binding:"required" gorm:"column:harga;type:varchar(100);not null"`
}
...
func (ItemTableNested) TableName() string {
	return "barang"
}
